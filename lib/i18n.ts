...
export const UI_STRINGS = [
  ...
  'Start a balanced session', 'Find a game', 'Good choices for today', 'Explore every activity', '{count} games · 400 levels', '{count} games · {levels} levels',
  'Continue Level {level}', 'Play Level {level}', 'Replay with a fresh shuffle', 'Exit', 'Exit game', 'Continue session',
  'Listen to question', 'Speaking…', 'Audio is not available on this device.',
  'Memory Chain', 'Remember the growing sequence, repeat it in order, and add one matching fruit or vegetable.',
  'Choose Fruits or Vegetables to begin your memory chain.', 'Choose a category', 'Fruits', 'Vegetables', 'fruit', 'vegetable',
  'Build a chain using fruit names.', 'Build a chain using vegetable names.', '{count} links remembered',
  'Remember the complete chain. Then hide it and repeat every item in order, adding one new {category}.',
  'Repeat the full chain in order, then add one new {category}.', 'Wonderful — you completed the full Memory Chain!',
  'That answer was not a recognized item from this category.', 'That item was already in the chain.', 'That sequence was not quite right.',
  'Correct — the chain is growing!', 'The chain is hidden', 'The chain is hidden. Recall it in order and add one new item.',
  'Memory chain sequence', 'System', 'I remember — hide the chain', 'Type or speak the whole chain', 'Example: Apple, Mango',
  'Speak my answer', 'Listening…', 'Check my chain', 'Good try — here is the chain to practise.', 'Try this category again',
  'Memory Chain complete!', 'You remembered the complete sequence and finished all 10 levels.',
